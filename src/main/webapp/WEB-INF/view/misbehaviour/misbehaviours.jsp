...
<body>
	<nav class="navbar navbar-inverse navbar-fixed-top">
		<div class="container">
			<div class="navbar-header">
				<a class="navbar-brand" href="<s:url value="/users/" />">Users/Misbehaviours app</a>
			</div>
			<div id="navbar" class="collapse navbar-collapse">
				<ul class="nav navbar-nav">
					<li><a href="<s:url value="/misbehaviours" />"
						title="View Users">View all misbehaviours</a></li>
	...
	<div class="container">
		<div class="jumbotron">
			...
			<p>These are the misbehaviours</p>
			<p><a href="<s:url value="/misbehaviours" />">See misbehaviours</a></p>
		</div>
		<h3>Request new misbehaviour</h3>
		<a class="btn btn-sm btn-success"
							href="<s:url value="/misbehaviours/new" />"
							title="Detailed info">Create new</a>
